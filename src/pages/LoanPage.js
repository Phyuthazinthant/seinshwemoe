    ...
    render() {
        ...
        return (
            ...
            < div class=" border-0 pb-3" >
              <div className=" text-center pb-3 font-weight-bolder">
              <MMText
                        text="အတိုးနှုန်းတွက်ရန်"
                        showFont={"unicode"}
                        conveter={"rabbit"}
                        detector={"knayi"}
                    />
                    ...
                    <div className="form-group d-flex flex-wrap pb-3 justify-content-center">
                ...
                <div className="text-center font-weight-bolder align-text-top ">Summary</div>
                    <div className="d-flex flex-row justify-content-center "> 
                        ...
                        <div className="col-xs-6 col-sm-6 col-md-4 col-lg-4 justify-content-end">8s000 MMK</div>
                     </div>
                        <div className="d-flex flex-row  justify-content-center"> 
